...
RT_v1_MetaType_String: Dict = {
	...
	RT_MetaType_v3.String: 'str',
	RT_MetaType_v3.Vec2: 'vec2',
	RT_MetaType_v3.Vec3: 'vec3',
	RT_MetaType_v3.Vec4: 'vec4',
	RT_MetaType_v3.Mat3x3: 'mat3',
	RT_MetaType_v3.Mat4x4: 'mat4',
	RT_MetaType_v3.UInteger32Array: 'a[uint32]',
	RT_MetaType_v3.Float32Array: 'a[f32]',
	RT_MetaType_v3.ByteArray: 'a[bytes]',
	RT_MetaType_v3.Deprecated: 'dep',
	RT_MetaType_v3.ObjectID: 'o_id',
...
class RT_Property_v1:
	...
	def __init__(self):
		...
		self.type: RT_MetaType_v3 = RT_MetaType_v3.Unassigned
		self.value: Any = None
	...
	def deserialize_complex_array(self, f: BinaryFile):
		...
		if self.type == RT_MetaType_v3.Vec2:
			self.value = list(f.read_f32(2))
		elif self.type == RT_MetaType_v3.Vec3:
			self.value = list(f.read_f32(3))
		elif self.type == RT_MetaType_v3.Vec4:
			self.value = list(f.read_f32(4))
		elif self.type == RT_MetaType_v3.Mat3x3:
			self.value = list(f.read_f32(9))
		elif self.type == RT_MetaType_v3.Mat4x4:
			self.value = list(f.read_f32(16))
		else:
			raise ValueError(f"RT_MetaType_v3 not a complex array: {self.type}")
	...
	def deserialize(self, f: BinaryFile, db_cursor=None):
		...
		self.type = RT_MetaType_v3(f.read_u8())
		
		# Base data types
		# Simple types
		if self.type in [RT_MetaType_v3.Unassigned, RT_MetaType_v3.UInteger32, RT_MetaType_v3.Float32]:
			if self.type == RT_MetaType_v3.Unassigned:
				return None
			...
			if self.type == RT_MetaType_v3.UInteger32:
				...
				raise KeyError("RT_MetaType_v3 not found.")
		...
		if self.type == RT_MetaType_v3.String:
			...
			count = f.read_u32()
			type_func = f.read_u32 if self.type == RT_MetaType_v3.UInteger32 else f.read_f32
			if count > 0:
	...
	def serialize(self, f: BinaryFile):
		...
		if self.type in [RT_MetaType_v3.UInteger32, RT_MetaType_v3.Float32]:
	...
	def write(self, f: BinaryFile) -> None:
		...
		if self.type == RT_MetaType_v3.Mat4x4:
	...
	def write_deferred(self, f: BinaryFile):
		if self.type == RT_MetaType_v3.String:
			...
			type_func = f.write_f32 if self.type == RT_MetaType_v3.Float32Array else f.write_u32
